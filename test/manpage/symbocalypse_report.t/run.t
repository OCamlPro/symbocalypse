  $ symbocalypse report --help=plain
  NAME
         symbocalypse-report - Generate a report from existing benchmarks
         results
  
  SYNOPSIS
         symbocalypse report [OPTION]… FILE
  ...
  EXIT STATUS
         symbocalypse report exits with:
